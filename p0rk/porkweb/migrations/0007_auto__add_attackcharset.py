...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AttackCharset'
        db.create_table(u'porkweb_attackcharset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('attack', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['porkweb.AttackType'])),
            ('charset', self.gf('django.db.models.fields.CharField')(default='AlphaNum', max_length=16)),
        ))
        db.send_create_signal(u'porkweb', ['AttackCharset'])


    def backwards(self, orm):
        # Deleting model 'AttackCharset'
        db.delete_table(u'porkweb_attackcharset')


    models = {
        u'porkweb.attackcharset': {
            'Meta': {'object_name': 'AttackCharset'},
            'attack': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['porkweb.AttackType']"}),
