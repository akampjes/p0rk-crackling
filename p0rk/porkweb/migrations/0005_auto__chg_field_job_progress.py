...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'porkweb_job', 'progress', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Job.progress'
        db.alter_column(u'porkweb_job', 'progress', self.gf('django.db.models.fields.FloatField')())
