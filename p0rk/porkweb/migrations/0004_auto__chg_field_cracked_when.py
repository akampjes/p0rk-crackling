...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cracked.when'
        db.alter_column(u'porkweb_cracked', 'when', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Cracked.when'
        db.alter_column(u'porkweb_cracked', 'when', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
